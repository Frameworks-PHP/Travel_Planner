...
@section('content')
		...
		<form class="form-horizontal" role="form" method="GET" action="/actualplain/{{ $budget->id }}">
            <div class="form-group">
		...
		<form class="form-horizontal" role="form" method="GET" action="/tripshow/{{ $budget->trip_id }}">
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-6">
					<button type="submit" class="btn btn-default">
